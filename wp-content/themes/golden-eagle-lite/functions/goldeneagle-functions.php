...
function goldeneagle_theme_suport() {
    ...
    register_nav_menu('custom_menu', __('Main Menu', 'golden-eagle-lite'));

    load_theme_textdomain('golden-eagle-lite', get_template_directory() . '/languages');
...
add_action('after_setup_theme', 'goldeneagle_theme_suport');
global $pagenow;
...
function goldeneagle_nav_menu_items($items) {
    if (is_home()) {
        $homelink = '<li class="current_page_item">' . '<a href="' . home_url('/') . '">' . __('Home', 'golden-eagle-lite') . '</a></li>';
    } else {
        $homelink = '<li>' . '<a href="' . home_url('/') . '">' . __('Home', 'golden-eagle-lite') . '</a></li>';
    }
...
function goldeneagle_breadcrumbs() {
    $delimiter = '&raquo;';
    $home = __('Home', 'golden-eagle-lite'); // text for the 'Home' link
    ...
    if (is_category()) {
        ...
        echo $before . __('Archive by category', 'golden-eagle-lite') . ' "' . single_cat_title('', false) . '"' . $after;
    }
    elseif (is_day()) {
        ...
        echo $before . __('Search results for', 'golden-eagle-lite') . ' "' . get_search_query() . '"' . $after;
    } elseif (is_tag()) {
        echo $before . __('Posts tagged ', 'golden-eagle-lite') . '"' . single_tag_title('', false) . '"' . $after;
    } elseif (is_author()) {
        global $author;
        $userdata = get_userdata($author);
        echo $before . __('Articles posted by ', 'golden-eagle-lite') . $userdata->display_name . $after;
    } elseif (is_404()) {
        echo $before . __('Error 404', 'golden-eagle-lite') . $after;
    }
    if (get_query_var('paged')) {
        if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author())
            echo ' (';
        echo __('Page', 'golden-eagle-lite') . ' ' . get_query_var('paged');
        if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author())
            echo ')';
    }
    echo '</div>';
 ...
 * @global type $posts
 */
function goldeneagle_main_image() {
    global $post, $posts;
...
// Retrieves tag list of current post, separated by commas.
    ...
    if ($tag_list) {
        $posted_in = __('This entry was posted in %1$s and tagged %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'golden-eagle-lite');
    } elseif (is_object_in_taxonomy(get_post_type(), 'category')) {
        $posted_in = __('This entry was posted in %1$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'golden-eagle-lite');
    } else {
        $posted_in = __('Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'golden-eagle-lite');
    }
...
// Area 1, located at the top of the sidebar.
    register_sidebar(array(
        'name' => __('Primary Widget Area', 'golden-eagle-lite'),
        'id' => 'primary-widget-area',
        'description' => __('The primary widget area', 'golden-eagle-lite'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<a><h3>',
        'after_title' => '</a></h3>',
...
// Area 2, located below the Primary Widget Area in the sidebar. Empty by default.
    register_sidebar(array(
        'name' => __('Secondary Widget Area', 'golden-eagle-lite'),
        'id' => 'secondary-widget-area',
        'description' => __('The secondary widget area', 'golden-eagle-lite'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<a><h3>',
        'after_title' => '</a></h3>',
    ...
    register_sidebar(array(
        'name' => __('First Footer Widget Area', 'golden-eagle-lite'),
        'id' => 'first-footer-widget-area',
        'description' => __('The first footer widget area', 'golden-eagle-lite'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
    ...
    register_sidebar(array(
        'name' => __('Second Footer Widget Area', 'golden-eagle-lite'),
        'id' => 'second-footer-widget-area',
        'description' => __('The second footer widget area', 'golden-eagle-lite'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
    ...
    register_sidebar(array(
        'name' => __('Third Footer Widget Area', 'golden-eagle-lite'),
        'id' => 'third-footer-widget-area',
        'description' => __('The third footer widget area', 'golden-eagle-lite'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
    ...
    // Area 5, located in the footer. Empty by default.
    register_sidebar(array(
        'name' => __('Fourth Footer Widget Area', 'golden-eagle-lite'),
        'id' => 'fourth-footer-widget-area',
        'description' => __('The fourth footer widget area', 'golden-eagle-lite'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
...
add_filter('wp_title', 'goldeneagle_filter_wp_title');
 ...
 * @uses	is_front_page()
 */
function goldeneagle_filter_wp_title($title) {
    global $page, $paged;
    ...
    $filtered_title .= ( 2 <= $paged || 2 <= $page ) ? ' | ' . sprintf(__('Page %s', 'golden-eagle-lite'), max($paged, $page)) : '';
