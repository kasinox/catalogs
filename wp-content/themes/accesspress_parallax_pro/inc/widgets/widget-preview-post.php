...
function register_preview_post_widget() {
    register_widget('accesspress_preview_post');
}

class Accesspress_Preview_Post extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'accesspress_preview_post', 
                'AP : Preview Post', 
                array(
                'description' => __('A widget that shows post/page preview', 'accesspress_parallax')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            // Other fields
            'post_id' => array(
                'accesspress_parallax_widgets_name' => 'post_id',
                'accesspress_parallax_widgets_title' => __('Post', 'accesspress_parallax'),
                'accesspress_parallax_widgets_field_type' => 'selectpost',
            ),
            'display_title' => array(
                'accesspress_parallax_widgets_name' => 'display_title',
                'accesspress_parallax_widgets_title' => __('Show post title', 'accesspress_parallax'),
                'accesspress_parallax_widgets_field_type' => 'checkbox'
            ),
            'display_thumbnail' => array(
                'accesspress_parallax_widgets_name' => 'display_thumbnail',
                'accesspress_parallax_widgets_title' => __('Show featured image', 'accesspress_parallax'),
                'accesspress_parallax_widgets_field_type' => 'checkbox'
            ),
            'display_excerpt' => array(
                'accesspress_parallax_widgets_name' => 'display_excerpt',
                'accesspress_parallax_widgets_title' => __('Show excerpt', 'accesspress_parallax'),
                'accesspress_parallax_widgets_field_type' => 'checkbox'
            ),
            'read_more_text' => array(
                'accesspress_parallax_widgets_name' => 'read_more_text',
                'accesspress_parallax_widgets_title' => __('Read more link text', 'accesspress_parallax'),
                'accesspress_parallax_widgets_description' => __('Leave empty for no link', 'accesspress_parallax'),
        ...
        if (isset($post_id)) {
            ...
            if ($post_object = get_post($post_id)) {
                ...
                <div class="ap-widget-preview wow zoomIn">
                    ...
                    if ($display_excerpt)
                        echo '<div class="widget-preview-excerpt">' . ( $post_object->post_excerpt ? $post_object->post_excerpt : accesspress_letter_count($post_object->post_content, 150) ) . '</div>';
