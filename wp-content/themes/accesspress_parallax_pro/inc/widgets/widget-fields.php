 ...
 */
function accesspress_parallax_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    // Store Posts in array
    $accesspress_parallax_postlist[0] = array(
        'value' => 0,
        'label' => '--choose--'
    );
    $arg = array('posts_per_page' => -1);
    $accesspress_parallax_posts = get_posts($arg);
    foreach ($accesspress_parallax_posts as $accesspress_parallax_post) :
        $accesspress_parallax_postlist[$accesspress_parallax_post->ID] = array(
            'value' => $accesspress_parallax_post->ID,
            'label' => $accesspress_parallax_post->post_title
        );
    endforeach;

    extract($widget_field);

    switch ($accesspress_parallax_widgets_field_type) {

        // Standard text field
        case 'text' :
            ?>
            <p>
                <label for="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>"><?php echo $accesspress_parallax_widgets_title; ?>:</label>
                <input class="widefat" id="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>" name="<?php echo $instance->get_field_name($accesspress_parallax_widgets_name); ?>" type="text" value="<?php echo $athm_field_value; ?>" />

                <?php if (isset($accesspress_parallax_widgets_description)) { ?>
                    <br />
                    <small><?php echo $accesspress_parallax_widgets_description; ?></small>
                <?php } ?>
            </p>
            <?php
            break;
        ...
        case 'textarea' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>"><?php echo $accesspress_parallax_widgets_title; ?>:</label>
                <textarea class="widefat" rows="<?php echo $accesspress_parallax_widgets_row; ?>" id="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>" name="<?php echo $instance->get_field_name($accesspress_parallax_widgets_name); ?>"><?php echo $athm_field_value; ?></textarea>
            </p>
            <?php
            break;
        ...
        case 'checkbox' :
            ?>
            <p>
                <input id="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>" name="<?php echo $instance->get_field_name($accesspress_parallax_widgets_name); ?>" type="checkbox" value="1" <?php checked('1', $athm_field_value); ?>/>
                <label for="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>"><?php echo $accesspress_parallax_widgets_title; ?></label>
        ...
        case 'radio' :
            ...
            <p>
                <?php
                echo $accesspress_parallax_widgets_title;
                echo '<br />';
                foreach ($accesspress_parallax_widgets_field_options as $athm_option_name => $athm_option_title) {
                    ?>
                    <input id="<?php echo $instance->get_field_id($athm_option_name); ?>" name="<?php echo $instance->get_field_name($accesspress_parallax_widgets_name); ?>" type="radio" value="<?php echo $athm_option_name; ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
        ...
        case 'select' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>"><?php echo $accesspress_parallax_widgets_title; ?>:</label>
                <select name="<?php echo $instance->get_field_name($accesspress_parallax_widgets_name); ?>" id="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>" class="widefat">
                    <?php foreach ($accesspress_parallax_widgets_field_options as $athm_option_name => $athm_option_title) { ?>
        ...
        case 'number' :
            ?>
            <p>
                <label for="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>"><?php echo $accesspress_parallax_widgets_title; ?>:</label><br />
                <input name="<?php echo $instance->get_field_name($accesspress_parallax_widgets_name); ?>" type="number" step="1" min="1" id="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" class="small-text" />
        ...
        case 'selectpost' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>"><?php echo $accesspress_parallax_widgets_title; ?>:</label>
                <select name="<?php echo $instance->get_field_name($accesspress_parallax_widgets_name); ?>" id="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>" class="widefat">
                    <?php foreach ($accesspress_parallax_postlist as $accesspress_parallax_single_post) { ?>
                        <option value="<?php echo $accesspress_parallax_single_post['value']; ?>" id="<?php echo $instance->get_field_id($accesspress_parallax_single_post['label']); ?>" <?php selected($accesspress_parallax_single_post['value'], $athm_field_value); ?>><?php echo $accesspress_parallax_single_post['label']; ?></option>
                    <?php } ?>
                </select>
        ...
        case 'upload' :
            ...
            $output = '';
            $id = $instance->get_field_id($accesspress_parallax_widgets_name);
            $class = '';
            $int = '';
            $value = $athm_field_value;
            $name = $instance->get_field_name($accesspress_parallax_widgets_name);
            ...
            $output .= '<label for="' . $instance->get_field_id($accesspress_parallax_widgets_name) . '">' . $accesspress_parallax_widgets_title . '</label><br/>';
            $output .= '<input id="' . $id . '" class="upload' . $class . '" type="text" name="' . $name . '" value="' . $value . '" placeholder="' . __('No file chosen', 'accesspress_parallax') . '" />' . "\n";
            if (function_exists('wp_enqueue_media')) {
                if (( $value == '')) {
                    $output .= '<input id="upload-' . $id . '" class="upload-button button" type="button" value="' . __('Upload', 'accesspress_parallax') . '" />' . "\n";
                } else {
                    $output .= '<input id="remove-' . $id . '" class="remove-file button" type="button" value="' . __('Remove', 'accesspress_parallax') . '" />' . "\n";
                }
            } else {
            ...
            if ($value != '') {
                $remove = '<a class="remove-image">'. __('Remove', 'accesspress_parallax').'</a>';
        ...
        case 'icon' :
            ...
            <p>
                ...
                <input class="hidden-icon-input" name="<?php echo $instance->get_field_name($accesspress_parallax_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($accesspress_parallax_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
...
function accesspress_parallax_widgets_updated_field_value($widget_field, $new_field_value) {

    extract($widget_field);

    // Allow only integers in number fields
    if ($accesspress_parallax_widgets_field_type == 'number') {
        return absint($new_field_value);

        // Allow some tags in textareas
    } elseif ($accesspress_parallax_widgets_field_type == 'textarea') {
        // Check if field array specifed allowed tags
        if (!isset($accesspress_parallax_widgets_allowed_tags)) {
            // If not, fallback to default tags
            $accesspress_parallax_widgets_allowed_tags = '<p><strong><em><a>';
        }
        return strip_tags($new_field_value, $accesspress_parallax_widgets_allowed_tags);

        // No allowed tags for all other fields
    } elseif ($accesspress_parallax_widgets_field_type == 'url') {
...
function optionsframework_media_scriptss($hook) {
    ...
    wp_register_script('of-media-uploader', get_template_directory_uri() . '/inc/options-framework/js/media-uploader.js', array('jquery'),'1.0');
    wp_enqueue_script('of-media-uploader');
    wp_localize_script('of-media-uploader', 'optionsframework_l10n', array(
        'upload' => __('Upload', 'accesspress_parallax'),
        'remove' => __('Remove', 'accesspress_parallax')
    ));

    wp_enqueue_style('accesspress_parallax-font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css');
    wp_enqueue_style('ap-admin-css', get_template_directory_uri() . '/inc/options-framework/css/ap-admin.css');
    wp_register_script('ap-admin-js', get_template_directory_uri() . '/inc/options-framework/js/ap-admin.js', array('jquery'));
