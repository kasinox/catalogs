 ...
 *
 * The variable passed to accesspress_parallax_register_plugins() should be an array of plugin
 * arrays.
 *
 * This function is hooked into accesspress_parallax_init, which is fired within the
...
function accesspress_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'version'            => '4.6.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
