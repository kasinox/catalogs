<?php
/*
Plugin Name: qq-connect
Plugin URI: http://jiaozhu.org/archives/1008.html
Description: 使用腾讯微博账号登陆 WordPress 博客！
Version: 2.4
Author: 教主
Author URI: http://jiaozhu.org
License: Copyright YEAR  PLUGIN_AUTHOR_NAME  (email : gitview@gmail.com)
...
*/
$qq_consumer_key = '7b68f7e0457a43c9a8b6dc47d01d019e';
$qq_consumer_secret = 'ed3c398fd0f478032b143ca3f3bcba79';
$sc_loaded = false;
...
?>
	<div class="wrap">
		...
		<form method="post" action="<?php menu_page_url('qc_options',true)?>">
        	<p>请先使用要绑定的腾讯微博帐号登录。然后推出再使用管理员帐号登录并在下面输入框中输入绑定的腾讯微博的用户名（不是 QQ 号，如：<a href="http://t.qq.com/jiaozhu/">jiaozhu</a>）。</p>
            <p>有问题请在腾讯微博上咨询 <a href="http://t.qq.com/jiaozhu/">jiaozhu</a>。</p>
...
if(!function_exists('jiaozhu_modify_dashboard_widgets')){
	
	add_action('wp_dashboard_setup', 'jiaozhu_modify_dashboard_widgets' );
	function jiaozhu_modify_dashboard_widgets() {
		global $wp_meta_boxes;
		
		wp_add_dashboard_widget('jiaozhu_dashboard_widget', '教主', 'jiaozhu_dashboard_widget_function');
	}
	
	function jiaozhu_dashboard_widget_function() {?>
		<p>
        <a href="http://jiaozhu.org" title="教主's Blog" target="_blank">教主's Blog</a> 发现、实践与分享，记录点滴生活</p>
        <hr />
	<?php 
		echo '<div class="rss-widget">';
		wp_widget_rss_output('http://jiaozhu.org/feed', array( 'show_author' => 0, 'show_date' => 1, 'show_summary' => 0 ));
		echo "</div>";
	}
}